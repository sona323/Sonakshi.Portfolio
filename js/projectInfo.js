const Projects = {
    Details:{//adding in opposite-chronological order, so it's easy to add later    
        ...
        WorkInProgress: {
            ID: "WorkInProgress",
            Name: "Ludo Empire",
            SmallDescription: "Unity, C#",
            LargeDescription: "Have you heard my Under Construction joke?<br>It's not done yet",
            DownloadLink: "https://play.google.com/store/apps/details?id=com.capermint.ludoempire&hl=en&gl=US",
            NoOfProjectImages: 1
        },
        TileVisualiser: {
            ID: "TileVisualiser",
        ...
        Homography: {
            ID: "Homography",
            Name: "Skill PAtti Game",
            SmallDescription: "Its card Game",
            ...
            DownloadLink: "https://play.google.com/store/apps/details?id=com.fabzen.skillpattiempire&hl=en&gl=US",
